...
def main():
    ...
    data1 = read("Elections Data\elections_df1.csv")
    data2 = read("Elections Data\elections_df2.csv")
    data3 = read("Elections Data\elections_df3.csv")
    data4 = read("Elections Data\elections_df4.csv")
    data5 = read("Elections Data\elections_df5.csv")
        ...
        if navigate2 == "Political Parties":
            ...
            if start < end and start >= time:
                ...
                if choice2 == "Social media mentions of political alliances in the 2022 general elections":
                    ...
                    words_clean =bigram.replace({'party' : {'kwanza': 'Kenya Kwanza', 'roots': 'Roots Party', 'kwisha': 'Kenya Kwanza', 'azimio': 'azimio OKA alliance', 'assimio':'azimio OKA alliance', 'uda': 'Kenya Kwanza', 'hustler nation': 'Kenya Kwanza', 'odm': 'azimio OKA alliance' }})
                    ...
                    source1 = source.sort_values(by='counts', ascending = False)               
    ...
    if navigation == "Presidential Election Prediction":
        ...
        if authentication_status:
            ...
            if start < end and start >= time:
                ...
                df1.drop((df1[df1['term']== 'None']).index, inplace=True)
                ...
                counts = [round(num, 1) for num in counts] 
